...
class Stabilimenti(models.Model):
    ...
    immagine =models.ImageField(upload_to=aziende_directory_path,default='/static/img/aziende/img/aziende.png', null=True, blank=True,help_text='Caricare un Immagine (opzionale)')
    ...
    def get_immagine(self):
        if not self.immagine:
            return '/static/img/aziende/img/aziende.png'
